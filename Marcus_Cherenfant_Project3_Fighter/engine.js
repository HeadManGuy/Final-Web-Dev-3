...
var block = new Audio("block.mp3");
var winTheme = new Audio("victory.mp3");
var loseTheme = new Audio("womp-womp.mp3");
...
function setText(){
    ...
    document.getElementById("battleLog").innerHTML = battleLogText;
}
